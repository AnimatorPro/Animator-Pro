;**********************************************************************
;
; EVGASS2.ASM --  Decode a FLI frame.
...
_text	segment	para public use32 'code'
	extrn _evga_put_hseg:near
	extrn _evga_double_hline:near
...
;evga_unss2 decodes a FLI_LS chunk of a flic frame.  
	public evga_unss2
; evga_unss2(v, cbuf, ytable, xoff, yoff)
; UBYTE *cbuf;  /* points to a FLI_LC chunk after chunk header. */
; Ytable *ytable;		  
evga_unss2 proc near
