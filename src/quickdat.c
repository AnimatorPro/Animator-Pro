...
static Button qmu_clusid_sel =
	MB_INIT1(&qmu_clus_sel, NOCHILD, 12, 9, 114, 44, /* w,h,x,y */
			 NODATA, see_clusid, toggle_clusid, ppalette, &qmu_clus_sel, 0, NOKEY, 0);

static Button qmu_minipal_sel =
	MB_INIT1(&qmu_clusid_sel, &minipal_sel, 29, 9, 114, 24, /* w,h,x,y */
			 NOTEXT, hang_children, NOFEEL, NOOPT, NULL, 0, NOKEY, 0);

/****** pen tool group ******/

static Button ptg_opt7_sel = MB_INIT1(NONEXT,        /* next */
									  NOCHILD,       /* children */
									  53, 9, 55, 30, /* w,h,x,y */
									  NOTEXT,        /* datme */
									  see_option_name, change_pen_mode, go_dtoolopts, &vs.ptool_id,
									  0, NOKEY, MB_GHILITE /* flags */
);
static Button ptg_opt6_sel = MB_INIT1(&ptg_opt7_sel, /* next */
									  NOCHILD,       /* children */
									  53, 9, 0, 30,  /* w,h,x,y */
									  NOTEXT,        /* datme */
									  see_option_name, change_pen_mode, go_dtoolopts, &vs.ptool_id,
...
static Button ptg_opt5_sel = MB_INIT1(&ptg_opt6_sel, /* next */
									  NOCHILD,       /* children */
									  53, 9, 55, 20, /* w,h,x,y */
									  NOTEXT,        /* datme */
									  see_option_name, change_pen_mode, go_dtoolopts, &vs.ptool_id,
...
static Button ptg_opt4_sel = MB_INIT1(&ptg_opt5_sel, /* next */
									  NOCHILD,       /* children */
									  53, 9, 0, 20,  /* w,h,x,y */
									  NOTEXT,        /* datme */
									  see_option_name, change_pen_mode, go_dtoolopts, &vs.ptool_id,
...
static Button ptg_opt3_sel = MB_INIT1(&ptg_opt4_sel, /* next */
									  NOCHILD,       /* children */
									  53, 9, 55, 10, /* w,h,x,y */
									  NOTEXT,        /* datme */
									  see_option_name, change_pen_mode, go_dtoolopts, &vs.ptool_id,
...
static Button ptg_opt2_sel = MB_INIT1(&ptg_opt3_sel, /* next */
									  NOCHILD,       /* children */
									  53, 9, 0, 10,  /* w,h,x,y */
									  NOTEXT,        /* datme */
									  see_option_name, change_pen_mode, go_dtoolopts, &vs.ptool_id,
...
static Button ptg_opt1_sel = MB_INIT1(&ptg_opt2_sel, /* next */
									  NOCHILD,       /* children */
									  53, 9, 55, 0,  /* w,h,x,y */
									  NOTEXT,        /* datme */
									  see_option_name, change_pen_mode, go_dtoolopts, &vs.ptool_id,
...
Button pen_opts_sel = MB_INIT1(&ptg_opt1_sel, /* next */
							   NOCHILD,       /* children */
							   53, 9, 0, 0,   /* w,h,x,y */
							   NOTEXT,        /* datme */
							   see_option_name, change_pen_mode, go_dtoolopts, &vs.ptool_id, 0,
							   NOKEY, MB_GHILITE /* flags */
);

/****** ink group ******/

static Button ig_ink7_sel = MB_INIT1(NONEXT,        /* next */
									 NOCHILD,       /* children */
									 53, 9, 55, 30, /* w,h,x,y */
									 NOTEXT,        /* datme */
									 see_option_name, change_ink_mode, go_inkopts, &vs.ink_id, 0,
									 NOKEY, MB_GHILITE /* flags */
);
static Button ig_ink6_sel = MB_INIT1(&ig_ink7_sel, /* next */
									 NOCHILD,      /* children */
									 53, 9, 0, 30, /* w,h,x,y */
									 NOTEXT,       /* datme */
									 see_option_name, change_ink_mode, go_inkopts, &vs.ink_id, 0,
...
static Button ig_ink5_sel = MB_INIT1(&ig_ink6_sel,  /* next */
									 NOCHILD,       /* children */
									 53, 9, 55, 20, /* w,h,x,y */
									 NOTEXT,        /* datme */
									 see_option_name, change_ink_mode, go_inkopts, &vs.ink_id, 0,
...
static Button ig_ink4_sel = MB_INIT1(&ig_ink5_sel, /* next */
									 NOCHILD,      /* children */
									 53, 9, 0, 20, /* w,h,x,y */
									 NOTEXT,       /* datme */
									 see_option_name, change_ink_mode, go_inkopts, &vs.ink_id, 0,
...
static Button ig_ink3_sel = MB_INIT1(&ig_ink4_sel,  /* next */
									 NOCHILD,       /* children */
									 53, 9, 55, 10, /* w,h,x,y */
									 NOTEXT,        /* datme */
									 see_option_name, change_ink_mode, go_inkopts, &vs.ink_id, 0,
...
static Button ig_ink2_sel = MB_INIT1(&ig_ink3_sel, /* next */
									 NOCHILD,      /* children */
									 53, 9, 0, 10, /* w,h,x,y */
									 NOTEXT,       /* datme */
									 see_option_name, change_ink_mode, go_inkopts, &vs.ink_id, 0,
...
static Button ig_ink1_sel = MB_INIT1(&ig_ink2_sel, /* next */
									 NOCHILD,      /* children */
									 53, 9, 55, 0, /* w,h,x,y */
									 NOTEXT,       /* datme */
									 see_option_name, change_ink_mode, go_inkopts, &vs.ink_id, 0,
...
Button ink_opts_sel = MB_INIT1(&ig_ink1_sel, /* next */
							   NOCHILD,      /* children */
							   53, 9, 0, 0,  /* w,h,x,y */
							   NOTEXT,       /* datme */
							   see_option_name, change_ink_mode, go_inkopts, &vs.ink_id, 0, NOKEY,
							   MB_GHILITE /* flags */
);

static Button qmu_grid_sel =
	MB_INIT1(&qmu_minipal_sel, NOCHILD,                                               /* children */
			 44, 9, 162, 34,                                                          /* w,h,x,y */
			 NODATA,                                                                  /* datme */
...
static Button qmu_mask_sel =
	MB_INIT1(&qmu_grid_sel,           /* next */
			 NOCHILD, 46, 9, 114, 34, /* w,h,x,y */
			 NODATA, see_mask_button, mb_toggle_mask, qmask, &vs.use_mask, 1, NOKEY, MB_B_GHILITE);
static Button qmu_penopts_sel =
	MB_INIT1(&qmu_mask_sel, &pen_opts_sel,                              /* next */
			 108, 39, 3, 14,                                            /* w,h,x,y */
			 NOTEXT, hang_children, NOFEEL, NOOPT, NOGROUP, 0, NOKEY, 0 /* flags */
	);

static Button qmu_inkopts_sel =
	MB_INIT1(&qmu_penopts_sel, &ink_opts_sel,                           /* next */
			 108, 39, 209, 14,                                          /* w,h,x,y */
			 NOTEXT, hang_children, NOFEEL, NOOPT, NOGROUP, 0, NOKEY, 0 /* flags */
	);

static Button qmu_zpan_sel = MB_INIT1(&qmu_inkopts_sel,                  /* next */
...
static Button qmu_redo_sel = MB_INIT1(&qmu_std1_sel, /* next */
									  NOCHILD,       /* children */
									  33, 9, 94, 3,  /* w,h,x,y */
									  NODATA,        /* datme */
									  see_redo, menu_doredo, NOOPT, NOGROUP, 0, 'r', 0 /* flags */
);
static Button qmu_undo_sel = MB_INIT1(&qmu_redo_sel, /* next */
									  NOCHILD,       /* children */
									  33, 9, 59, 3,  /* w,h,x,y */
									  NODATA,        /* datme */
...
static Redraw_node quick_rn = {{NULL, NULL}, /* node */
							   qmu_color_redraw,
							   NULL,
							   NEW_CCOLOR};
...
Menuhdr quick_menu = MENU_INIT0(320, 55, 0, 165, QUICK_MUID, /* id */
								PANELMENU,                   /* type */
